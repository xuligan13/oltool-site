...
import { ArrowLeft, Flame, ImageIcon, Package } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-20 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        {!products || products.length === 0 ? (
          <div className="text-center py-32 bg-white rounded-[3rem] shadow-xl shadow-slate-200/50 border-2 border-dashed border-slate-100">
            ...
            {products.map((product) => (
              ...
              >
                ...
                <CardHeader className="p-8 pb-4">
                  <CardTitle className="text-2xl font-black text-slate-900 line-clamp-1 group-hover:text-primary transition-colors leading-none">
                    {product.name}
                  </CardTitle>
                </CardHeader>
